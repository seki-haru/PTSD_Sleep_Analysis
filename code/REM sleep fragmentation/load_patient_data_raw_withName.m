...
for i=1:size(folders,2)
    ...
    [T{i,1},N{i,2}]=get_data_each_patient(NightPath); % Get sleep stage data for the subject and store recording ID
end
...
for fileIndex = 1:length(files)
    ...
    % Replace sleep names to numeric values
    numericVector=table2hypno(data);
...
% Extract the sleep stage data column
sleepStagesCellArray=data{:,3};
